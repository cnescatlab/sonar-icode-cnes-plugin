...
/**
 * Declares language Fortran 77.
 */
public final class Fortran77Language extends ICodeLanguage {

	/**
	 * Name of the language.
	 */
	public static final String NAME = "Fortran 77";
	/**
	 * Key of the language.
	 */
	public static final String KEY = "f77";
	 ...
	 */
	public Fortran77Language(final Configuration configuration) {
	...
	public String getSuffixKey() {
		return ICodePluginProperties.F77_SUFFIX_KEY;
	}
	...
	public String getDefaultSuffixes() {
		return ICodePluginProperties.F77_SUFFIX_DEFAULT;
	}
