...
import static fr.cnes.sonar.plugins.icode.measures.ICodeMetricsF77Nesting.F77_NESTING;
import static fr.cnes.sonar.plugins.icode.measures.ICodeMetricsF77Nesting.F77_NESTING_MEAN;
import static fr.cnes.sonar.plugins.icode.measures.ICodeMetricsF77Nesting.F77_NESTING_MIN;
import static fr.cnes.sonar.plugins.icode.measures.ICodeMetricsF77Nesting.F77_NESTING_MAX;
...
public class ComputeModuleF77NestingStatistics implements MeasureComputer {
	...
	public MeasureComputerDefinition define(MeasureComputerDefinitionContext defContext) {		
	    String[] metricTab = new String[] {F77_NESTING.key(),F77_NESTING_MEAN.key(),F77_NESTING_MIN.key(),F77_NESTING_MAX.key()};
