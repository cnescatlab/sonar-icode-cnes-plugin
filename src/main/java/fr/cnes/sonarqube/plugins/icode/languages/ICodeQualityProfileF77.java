 ...
 */
public final class ICodeQualityProfileF77 implements BuiltInQualityProfilesDefinition  {
	 static final String I_CODE_RULES_PROFILE_NAME = "ICode Rules F77";
	...
	public void define(Context context) {
		...
		for (String ruleKey : allKeys) {
			if(!ruleKey.startsWith("SH") && !ruleKey.startsWith("F90")) {
