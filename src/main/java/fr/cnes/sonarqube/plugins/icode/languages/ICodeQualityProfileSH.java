 ...
 */
public final class ICodeQualityProfileSH implements BuiltInQualityProfilesDefinition  {
	 static final String I_CODE_RULES_PROFILE_NAME = "ICode Rules SH";
	...
	public void define(Context context) {
		...
		for (String ruleKey : allKeys) {
			if(!ruleKey.startsWith("F77") && !ruleKey.startsWith("F90")) {
