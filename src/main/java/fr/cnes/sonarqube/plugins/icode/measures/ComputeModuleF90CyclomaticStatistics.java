...
public class ComputeModuleF90CyclomaticStatistics implements MeasureComputer {
	...
	public MeasureComputerDefinition define(MeasureComputerDefinitionContext defContext) {
	    ...
	    return defContext.newDefinitionBuilder()
	    		.setInputMetrics(new String[] {F90_CYCLOMATIC.key(),F90_CYCLOMATIC_MEAN.key(),F90_CYCLOMATIC_MIN.key(),F90_CYCLOMATIC_MAX.key()})
	    		.setOutputMetrics(new String[] {F90_CYCLOMATIC.key(),F90_CYCLOMATIC_MEAN.key(),F90_CYCLOMATIC_MIN.key(),F90_CYCLOMATIC_MAX.key()})//,DBG.key()})
	    		.build();
	}
